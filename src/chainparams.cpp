...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Desire: 1 day
	...
	assert(consensus.hashGenesisBlock == uint256S("0x8ddece7e8b4f5be6d11ec2a24a5febaa226cdf60fadc6e276666bde91b13696b"));
		...
		vSeeds.push_back(CDNSSeedData("desire_node_1", "95.46.114.23"));
	...
	//    vSeeds.push_back(CDNSSeedData("unimining.net", "164.132.18.89"));
      //  vSeeds.push_back(CDNSSeedData("bigmine", "194.67.213.243"));
        ...
        // Desire BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Desire BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Desire BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x8ddece7e8b4f5be6d11ec2a24a5febaa226cdf60fadc6e276666bde91b13696b")),
            1520794201, // * UNIX timestamp of last checkpoint block
...
public:
	...
	assert(consensus.hashGenesisBlock == uint256S("0x8ddece7e8b4f5be6d11ec2a24a5febaa226cdf60fadc6e276666bde91b13696b"));
        ...
        // Testnet Desire script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Desire BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Desire BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Desire BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
	...
	assert(consensus.hashGenesisBlock == uint256S("0x8ddece7e8b4f5be6d11ec2a24a5febaa226cdf60fadc6e276666bde91b13696b"));
        ...
        // Regtest Desire addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Desire script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Desire BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Desire BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Desire BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
